...
ec2_instance = ItemDynamicLayout.set_fields('Azure VM', fields=[
    TextDyField.data_source('VM ID', 'data.compute.instance_id'),
...
ec2_vpc = ItemDynamicLayout.set_fields('VNet', fields=[
